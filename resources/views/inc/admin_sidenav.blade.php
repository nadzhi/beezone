            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul id="mainnav-menu" class="list-group">
						...
						<li class="{{ areActiveRoutes(['stat.index'])}}">
                            <a class="nav-link" href="{{ route('stat.index') }}">
                                ...
                                <li>
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="{{ areActiveRoutes(['privacypolicy.index'])}}">
                                            <a class="nav-link" href="{{route('privacypolicy.index', 'privacy_policy')}}">Политика Конфиденциальности</a>
                                        </li>
                                    </ul>
