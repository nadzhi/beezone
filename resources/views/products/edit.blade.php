			...
			<div class="panel-body">
				<div class="tab-base tab-stacked-left">
				    ...
				    <ul class="nav nav-tabs">
						...
						<?php if(\App\BusinessSetting::where('type', 'seller_system')->first()->value == 1): ?>
							<li class="">
								<a data-toggle="tab" href="#demo-stk-lft-tab-11" aria-expanded="false">Похожие</a>
							</li>
						<?php endif; ?>
				    </ul>
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-lg-7">
	                                <input type="text" class="form-control" name="tags[]" id="tags" value="{{ $product->tags }}" placeholder="Введите,чтобы добавить тег" data-role="tagsinput">
	                            </div>
	                        </div>
				        </div>
								...
								@foreach (json_decode($product->choice_options) as $key => $choice_option)
									<div class="form-group">
										<div class="col-lg-2">
											...
											<input type="text" class="form-control" name="choice[]" value="{{ $choice_option->title }}" placeholder="Выбор названия">
										</div>
										<div class="col-lg-7">
											<input type="text" class="form-control" name="choice_options_{{ explode('_', $choice_option->name)[1] }}[]" placeholder="Введите значения выбора" value="{{ implode(',', $choice_option->options) }}" data-role="tagsinput" onchange="update_sku()">
										</div>
										<div class="col-lg-2">
						...
						<div id="demo-stk-lft-tab-9" class="tab-pane fade">
							...
							<div class="row bord-btm">
								<div class="col-md-2">
									<div class="panel-heading">
										<h3 class="panel-title">Единая ставка</h3>
									</div>
								</div>
								<div class="col-md-10">
									<div class="form-group">
						...
						<div id="demo-stk-lft-tab-11" class="tab-pane fade">
							<div class="form-group">
								<div class="col-lg-12">
									@php
										$data = [];
										$same_products = \App\SameProduct::select('same_product_id')->where('product_id', $product->id)->get();
										foreach($same_products as $item){
											$data[] = $item->same_product_id;
										}
									@endphp
									<select class="form-control color-var-select" name="same_products[]" multiple >
										@foreach (\App\Product::orderBy('name', 'asc')->get() as $key => $sproduct)
											<option value="{{ $sproduct->id }}" <?php if(in_array($sproduct->id, $data)) echo 'selected'?> >
												{{ $sproduct->name }}
										</option>
										@endforeach
									</select>
...
<script type="text/javascript">
	...
	function add_more_customer_choice_option(){
		i++;
		$('#customer_choice_options').append('<div class="form-group"><div class="col-lg-2"><input type="hidden" name="choice_no[]" value="'+i+'"><input type="text" class="form-control" name="choice[]" value="" placeholder="Выбор названия"></div><div class="col-lg-7"><input type="text" class="form-control" name="choice_options_'+i+'[]" placeholder="Введите значения выбора" data-role="tagsinput" onchange="update_sku()"></div><div class="col-lg-2"><button onclick="delete_row(this)" class="btn btn-danger btn-icon"><i class="demo-psi-recycling icon-lg"></i></button></div></div>');
