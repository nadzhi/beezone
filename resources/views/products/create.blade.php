				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" name="tags[]" placeholder="Введите,чтобы добавить тег" data-role="tagsinput">
								</div>
							</div>
				        </div>
							...
							<div class="form-group">
								<div class="col-lg-12">
									<select class="form-control color-var-select" name="same_products[]" multiple >
										@foreach (\App\Product::orderBy('name', 'asc')->get() as $key => $product)
