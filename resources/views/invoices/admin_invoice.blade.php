	...
	*{
    ...
    <div style="padding:0 1.5rem;">
        <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
	        <tbody>
		        <tr>
		            <th class="gry-color text-left">Промежуточный итог</td>
		            <td>{{ single_price($order->orderDetails->sum('price')) }}</td>
		        </tr>
		        <tr>
		            <th class="gry-color text-left">Стоимость доставки</td>
		            <td>{{ single_price($order->orderDetails->sum('shipping_cost')) }}</td>
		        </tr>
		        <tr class="border-bottom">
		            <th class="gry-color text-left">Налог</td>
		            <td>{{ single_price($order->orderDetails->sum('tax')) }}</td>
		        </tr>
		        <tr>
		            <th class="text-left strong">Общая сумма</td>
