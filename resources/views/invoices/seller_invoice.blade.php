...
<div style="margin-left:auto;margin-right:auto;">
	...
	<div style="background: #eceff4;padding: 1.5rem;">
		...
		<table>
			@if (Auth::user()->user_type == 'seller')
				...
				<tr>
					<td class="gry-color small">Телефон: {{ Auth::user()->phone }}</td>
					<td class="text-right small"><span class="gry-color small">Дата заказа:</span> <span class=" strong">{{ date('d-m-Y', $order->date) }}</span></td>
				</tr>
			@else
				<tr>
    ...
    <div style="padding:0 1.5rem;">
        <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
	        <tbody>
		        <tr>
		            <th class="text-left strong">Общая сумма</th>
