                            ...
                            <div class="col-md-4">
                                <div class="dashboard-widget text-center green-widget mt-4 c-pointer">
                                    <a href="javascript:;" class="d-block">
                                        ...
                                        @if(Session::has('cart'))
                                            <span class="d-block title">Товаров: {{ count(Session::get('cart'))}}</span>
                                        @else
                                            <span class="d-block title">0 Товаров</span>
                                        @endif
                                        <span class="d-block sub-title">в вашей корзине</span>
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="dashboard-widget text-center red-widget mt-4 c-pointer">
                                    <a href="javascript:;" class="d-block">
                                        ...
                                        <span class="d-block title">Товаров: {{ count(Auth::user()->wishlists)}}</span>
                                        <span class="d-block sub-title">в избранном</span>
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="dashboard-widget text-center yellow-widget mt-4 c-pointer">
                                    <a href="javascript:;" class="d-block">
                                        ...
                                        @endphp
                                        <span class="d-block title">Товаров:  {{ $total }}</span>
                                        <span class="d-block sub-title">вы заказали</span>
                                    </a>
                                </div>
                            </div>
                        </div>
