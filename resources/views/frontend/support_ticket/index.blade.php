                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif ($ticket->status == 'open')
                                                    <span class="badge badge-pill badge-secondary">Открыто</span>
                                                @else
                                                    <span class="badge badge-pill badge-success">Решено</span>
                                                @endif
                                            </td>
                                            <td>
            ...
            <div class="modal-body px-3 pt-3">
                <form class="" action="{{ route('support_ticket.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control editor" name="details" placeholder="Введите свой ответ" data-buttons="bold,underline,italic,|,ul,ol,|,paragraph,|,undo,redo"></textarea>
                    </div>
                    <div class="form-group">
