            ...
            $("body").on("click",".product-level-minus-button",function(){
                ...
                if((value_count-data_count) > 0){
                    ...
                    $.each(levels_list, function(index, value) {
                        let last_item_of_levels_list = levels_list.length - 1;
                        let level_val = levels_list[index+1];
                        if((index+1) > last_item_of_levels_list){
                            level_val = levels_list[last_item_of_levels_list]
                        }
                        if(level_val > (value_count-data_count)){
            ...
            $("body").on("click",".product-level-plus-button",function(){
                ...
                $.each(levels_list, function(index, value) {
                    ...
                    if(value == (value_count+data_count)){
                        let last_item_of_prices_list = prices_list.length - 1;
                        price_value = prices_list[last_item_of_prices_list];
                        object_price_sum.html(formatNumber(price_value) + "₸");
                        return false;
                    }
                });
