                                        ...
                                        <tbody>
                                            @foreach ($orders as $key => $order)
                                                <tr>
                                                    ...
                                                    <td>
														@php
															if(isset($order->orderDetails->first()->delivery_status)){
                                                    ...
                                                    <td>
                                                        <span class="badge badge--2 mr-4">
                                                        	<?php $order_detail =  $order->orderDetails->first();
																if(isset($order_detail)): ?>
																	<?php if($order_detail->payment_status == 'consignation'): ?>
																		<i class="bg-green"></i> Консигнация
																	<?php elseif($order_detail->payment_status == 'paid'): ?>
