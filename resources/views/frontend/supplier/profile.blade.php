            ...
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-9">
                    <div class="main-content">
                        ...
                        <form class="" action="{{ route('supplier.profile.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="email" id="email" class="form-control mb-3" placeholder="{{__('Your Email')}}" name="email" value="{{ Auth::user()->email }}" disabled>
											<?php if(Auth::user()->email_verify == 0): ?>
												<p style="color: #f44336">
													Ваш Email не подтвержден!
													<a onclick="verifyEmail()" style="color:#2196f3;cursor:pointer;font-weight: bold;">Подтвердить</a>
												</p>
											<?php else: ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="file" name="passport" id="file-4" class="custom-input-file custom-input-file--4" data-multiple-caption="{count} files selected" accept="image/*" />
...
<script>
	function verifyEmail(){
		let email = $("#email").val();
		$.post('{{ route('verify_email') }}', {_token:'{{ csrf_token() }}',email: email}, function(data){
			if(data == "1"){
				swal({
					position: 'top-end',
					type: "success",
					title: "На ваш Email успешно отправлена ссылка с подтверждением!",
