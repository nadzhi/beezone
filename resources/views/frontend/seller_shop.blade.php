...
@section('content')
    ...
    <section class="gry-bg pt-4 bwrapper">
        <div class="container">
    ...
    <section class="bg-white">
        <div class="container">
            <div class="row sticky-top mt-4 bwrapper">
                <div class="col">
    ...
    <section class="@if (!isset($type)) gry-bg @endif pt-5 bwrapper">
        <div class="container">
            <div class="row">
