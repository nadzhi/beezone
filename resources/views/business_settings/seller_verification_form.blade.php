								...
								@elseif ($element->type == 'select' || $element->type == 'multi_select' || $element->type == 'radio')
									<div class="form-group" style="background:rgba(0,0,0,0.1);padding:10px 0;">
									    ...
									    <div class="col-lg-7">
									        ...
									        <button class="btn btn-success pull-right" type="button" onclick="add_customer_choice_options(this)"><i class="glyphicon glyphicon-plus"></i>Добавить опцию</button>
									    </div>
									    <div class="col-lg-2"><span class="btn btn-icon btn-circle icon-lg fa fa-times" onclick="delete_choice_clearfix(this)"></span></div>
									</div>
								@endif
		...
		function appenddToForm(type){
			...
			if(type == 'text'){
				var str = '<div class="form-group" style="background:rgba(0,0,0,0.1);padding:10px 0;">'
								...
								+'</div>'
								+'<div class="col-lg-7">'
									+'<input class="form-control" type="text" name="label[]" placeholder="Метка">'
								+'</div>'
								+'<div class="col-lg-2">'
				...
				var str = '<div class="form-group" style="background:rgba(0,0,0,0.1);padding:10px 0;">'
								...
								+'</div>'
								+'<div class="col-lg-7">'
									+'<input class="form-control" type="text" name="label[]" placeholder="Выбрать метку" style="margin-bottom:10px">'
									+'<div class="customer_choice_options_types_wrap_child">'
				...
				var str = '<div class="form-group" style="background:rgba(0,0,0,0.1);padding:10px 0;">'
								...
								+'<div class="col-lg-3">'
									+'<label class="control-label">Множественный выбор</label>'
								+'</div>'
								+'<div class="col-lg-7">'
									+'<input class="form-control" type="text" name="label[]" placeholder=Множественный выбор" style="margin-bottom:10px">'
									+'<div class="customer_choice_options_types_wrap_child">'
				...
				var str = '<div class="form-group" style="background:rgba(0,0,0,0.1);padding:10px 0;">'
								...
								+'<div class="col-lg-3">'
									+'<label class="control-label">Радио</label>'
								+'</div>'
								+'<div class="col-lg-7">'
									+'<input class="form-control" type="text" name="label[]" placeholder="Радио метка" style="margin-bottom:10px">'
									+'<div class="customer_choice_options_types_wrap_child">'
