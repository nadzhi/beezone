...
<div class="row">
        ...
        <div class="panel">
            ...
            <div class="panel-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    Вам нужно правильно настроить SMTP, чтобы включить эту функцию.<a href="{{ route('smtp_settings.index') }}">Настроить сейчас</a>
                </div>
            </div>
        </div>
    </div>
	<div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">{{__('Seller Settings')}}</h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
                    <input type="checkbox" onchange="updateSettings(this, 'seller_system')" <?php if(\App\BusinessSetting::where('type', 'seller_system')->first()->value == 1) echo "checked";?>>
                    <span class="slider round"></span>
                </label>
            </div>
        </div>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="alert text-center" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    Вам нужно правильно настроить Paypal, чтобы включить эту функцию. <a href="{{ route('payment_method.index') }}">Настроить сейчас</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    Вам нужно правильно настроить Stripe, чтобы включить эту функцию. <a href="{{ route('payment_method.index') }}">Настроить сейчас</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    Вам необходимо правильно настроить SSlCommerz, чтобы включить эту функцию. <a href="{{ route('payment_method.index') }}">Настроить сейчас</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    Вам необходимо правильно настроить оплату Instamojo, чтобы включить эту функцию. <a href="{{ route('payment_method.index') }}">Настроить сейчас</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    Вам нужно правильно настроить Razor, чтобы включить эту функцию.<a href="{{ route('payment_method.index') }}">Настроить сейчас</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    Вам необходимо правильно настроить PayStack, чтобы включить эту функцию.<a href="{{ route('payment_method.index') }}">Настроить сейчас</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    Вам необходимо правильно настроить клиент Facebook, чтобы включить эту функцию. <a href="{{ route('social_login.index') }}">Настроить сейчас</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    Вам необходимо правильно настроить клиент Google Client, чтобы включить эту функцию. <a href="{{ route('social_login.index') }}">Настроить сейчас</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    Вам необходимо правильно настроить клиент Twitter Client, чтобы включить эту функцию. <a href="{{ route('social_login.index') }}">Настроить сейчас</a>
                </div>
            </div>
        </div>
    </div>
