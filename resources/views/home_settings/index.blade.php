...
@section('content')
    ...
    <div class="tab-base">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-5" aria-expanded="false">{{ __('Топ 10') }}</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div id="demo-lft-tab-2" class="tab-pane fade">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{__('Home banner')}} (Максимум 3)</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            <thead>
            ...
            <div id="demo-lft-tab-3" class="tab-pane fade">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{__('Home banner')}} (Максимум 10)</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped table-bordered demo-dt-basic" cellspacing="0" width="100%">
                            <thead>
    ...
    function updateSettings(el, type){
        ...
        $.post('{{ route('business_settings.update.activation') }}', {_token:'{{ csrf_token() }}', type:type, value:value}, function(data){
            if(data == 1){
                ...
                showAlert('danger', 'Что-то пошло не так');
            }
        });
    }
